        ...
        {!activeCategorie ? (
          <>
            <div className="grid grid-cols-2 gap-2">
              ...
              <Button variant="outline" size="sm" onClick={() => navigate('/produit/nouveau')}>
              ...
              <Button variant="outline" size="sm" className="col-span-2" onClick={() => navigate('/abonnement-pub')}>
                <Megaphone size={16} className="mr-1" /> Espace pub — dès 1 000 F / jour
              </Button>
            </div>
